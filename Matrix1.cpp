...
int main(int argc, char *argv[])
{
    ...
    ret = PAPI_add_event(EventSet, PAPI_FP_OPS); // Floating point operations
    if (ret != PAPI_OK)
    ...
    ret = PAPI_add_event(EventSet, PAPI_TOT_CYC); // Total cycles completed
    if (ret != PAPI_OK)
        cout << "ERROR: PAPI_TOT_CYC" << endl;

    ret = PAPI_add_event(EventSet, PAPI_BR_MSP); // Branch misspredictions
    if (ret != PAPI_OK)
        cout << "ERROR: PAPI_BR_MSP" << endl;
